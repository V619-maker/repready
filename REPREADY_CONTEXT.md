...
# Last updated: September 6, 2026 (Sprint 32 — CORS/credentials contradiction fix; Sprint 31 —
# clickjacking header fix; Sprint 30 — vendored compound-engineering-plugin skills — all landed
# the same day. See those entries for detail. Prior major update: September 2, 2026 full
# codebase audit, Sprint 27)
