  ...
  return (
    <div style={S.page}>
      ...
      <div style={S.content}>
        ...
        {/* Hero */}
        <section className="reveal-section"{{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '80px 40px', position: 'relative', zIndex: 10 }}>
