...
const S = {
  page: { position: 'relative', minHeight: '100vh', background: '#0a0d14', fontFamily: 'monospace', color: '#fff' },
  grid: { position: 'fixed', inset: 0, opacity: 0.06, pointerEvents: 'none', zIndex: 0, backgroundImage: 'linear-gradient(rgba(0,200,224,0.3) 1px, transparent 1px), linear-gradient(90deg, rgba(0,200,224,0.3) 1px, transparent 1px)', backgroundSize: '60px 60px' },
  nav: { position: 'fixed', top: 0, left: 0, right: 0, height: 64, background: 'rgba(10,13,20,0.95)', borderBottom: '1px solid rgba(0,200,224,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 24px 0 130px', zIndex: 200, backdropFilter: 'blur(12px)' },
  sidebar: { position: 'fixed', left: 0, top: 0, bottom: 0, width: 100, background: '#050505', borderRight: '1px solid rgba(0,200,224,0.1)', display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: 80, zIndex: 100, gap: 8 },
  content: { paddingLeft: 100, paddingTop: 64 },
};
  ...
  return (
    <div style={S.page}>
      ...
      <div style={S.content}>
        ...
        {/* Hero */}
        <section style= className="reveal-section"{{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '80px 40px', position: 'relative', zIndex: 10 }}>
        ...
        {/* Stats */}
        <section style=className="reveal-section"{{ padding: '80px 40px', position: 'relative', zIndex: 10 }}>
          <div style={{ maxWidth: 1000, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 1, background: 'rgba(0,200,224,0.1)' }}>
            {[
              ...
              {/* Built for */}
<section style=className="reveal-section"{{ padding: '80px 40px', background: '#0d1117', borderTop: '1px solid rgba(255,255,255,0.05)', position: 'relative', zIndex: 10 }}>
  ...
  <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
    ...
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 16 }}>
      ...
      <div style={{ textAlign: 'left' }}>
        ...
        <section style=className="reveal-section"{{ padding: '80px 40px', position: 'relative', zIndex: 10 }}>
          <div style={{ maxWidth: 1000, margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
              {[
                {
                  name: 'Richard Vance', role: 'VP Procurement', company: '500-person Logistics Firm', img: '/Richard.png', color: '#00c8e0',
                  traits: ['Anchors hard on price in the first 60 seconds', 'Uses silence as a weapon — waits you out', 'References 3 competing vendors whether they exist or not', 'Escalates to CFO approval threat when cornered']
                },
                {
                  name: 'Sandra Chen', role: 'Head of IT', company: '800-person Financial Firm', img: '/Sandra.png', color: '#e84545',
                  traits: ["Aggressively protects her team's bandwidth", 'Claims zero implementation capacity this quarter', 'Demands SOC 2 Type II before any conversation', 'Requires native SAML/SSO as a hard blocker']
                }
              ].map((p, i) => (
        ...
        {/* System Architecture */}
        <section style=className="reveal-section"{{ padding: '80px 40px', background: '#0d1117', borderTop: '1px solid rgba(0,200,224,0.1)', borderBottom: '1px solid rgba(0,200,224,0.1)', position: 'relative', zIndex: 10 }}>
          <div style={{ maxWidth: 1000, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
        ...
        {/* CTA Banner */}
        <section style=className="reveal-section"{{ padding: '100px 40px', background: '#050505', borderTop: '1px solid rgba(0,200,224,0.1)', textAlign: 'center', position: 'relative', zIndex: 10, overflow: 'hidden' }}>
